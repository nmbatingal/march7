    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <p class="text-muted m-t-30 m-b-30">YOU DON'T HAVE ENOUGH PERMISSION TO ACCESS ON THIS PAGE.</p>
                <a href="{{ url()->previous() }}" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to previous</a> </div>
